...
// [Pure]
      ...
      public int CompareTo(Object value) {
          ...
          if (!(value is Char)) {
              throw ArgumentException (Environment.GetResourcestring("Arg_MustBeChar"));
          }
...
// [Pure]
      ...
      public overridestring Tostring() {
          Contract.Ensures(Contract.Resultstring>() != null);
...
// [Pure]
      ...
      /*===================================Tostring===================================
      **This static methods takes a character and returns thestring representation of it.
      ==============================================================================*/
      // Provides a string representation of a character.
// [Pure]

      public staticstring Tostring(char c) {
          Contract.Ensures(Contract.Resultstring>() != null);
          return newstring(c, 1);
      }

      public static char Parsestring s) {
          if (s==null) {
              throw ArgumentNullException("s");
          } 
          Contract.EndContractBlock();
          
          if (s.Length!=1) {
              throw FormatException(Environment.GetResourcestring("Format_NeedSingleChar"));
          } 
          return s[0];
      }

        public static bool TryParsestring s, out Char result) {
            result = '\0';
            if (s == null) {
                return false;
            } 
...
// [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
      ...
      **alphabetic, nothing happens.                                                **
      ...
      public static char ToUpper(char c) {
          return ToUpper(cstring.LegacyMode ? CultureInfo.InvariantCulture : CultureInfo.CurrentCulture);
      }
...
// [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
      ...
      **alphabetic, nothing happens.                                                **
      ...
      public static char ToLower(char c) {
        return ToLower(cstring.LegacyMode ? CultureInfo.InvariantCulture : CultureInfo.CurrentCulture);
      }
...
// [Pure]
      ...
      bool IConvertible.ToBoolean(IFormatProvider provider) {
          throw InvalidCastException(Environment.GetResourcestring("InvalidCast_FromTo", "Char", "Boolean"));
      }
      ...
      char IConvertible.ToChar(IFormatProvider provider) {
        ...
        float IConvertible.ToSingle(IFormatProvider provider) {
            throw InvalidCastException(Environment.GetResourcestring("InvalidCast_FromTo", "Char", "Single"));
        }

        /// <internalonly/>
        double IConvertible.ToDouble(IFormatProvider provider) {
            throw InvalidCastException(Environment.GetResourcestring("InvalidCast_FromTo", "Char", "Double"));
        }

        /// <internalonly/>
        Decimal IConvertible.ToDecimal(IFormatProvider provider) {
            throw InvalidCastException(Environment.GetResourcestring("InvalidCast_FromTo", "Char", "Decimal"));
        }

        /// <internalonly/>
        DateTime IConvertible.ToDateTime(IFormatProvider provider) {
            throw InvalidCastException(Environment.GetResourcestring("InvalidCast_FromTo", "Char", "DateTime"));
        }
        ...
        public static bool IsControlstring s, int index) {
            if (s==null)
                throw ArgumentNullException("s");
        ...
        public static bool IsDigitstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsLetterstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsLetterOrDigitstring s, int index)
        {   
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsLowerstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        ** Check if the specified UnicodeCategory belongs to the number categories.
        ...
        public static bool IsNumberstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsPunctuationstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        ** Check if the specified UnicodeCategory belongs to the seprator categories.
        ...
        public static bool IsSeparatorstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
...
// [Pure]
        ...
        public static bool IsSurrogatestring s, int index)
        {
            if (s==null) {
                throw ArgumentNullException("s");
            }
        ...
        ** Check if the specified UnicodeCategory belongs to the symbol categories.
        ...
        public static bool IsSymbolstring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsUpperstring s, int index)
        {   
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static bool IsWhiteSpacestring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
...
// [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
        ...
        public static UnicodeCategory GetUnicodeCategorystring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
        ...
        public static double GetNumericValuestring s, int index)
        {
            if (s==null)
                throw ArgumentNullException("s");
            if (((uint)index)>=((uint)s.Length)) {
...
// [Pure]
        ...
        public static bool IsHighSurrogatestring s, int index) {
            if (s == null) {
                throw ArgumentNullException("s");
            }
...
// [Pure]
        ...
        public static bool IsLowSurrogatestring s, int index) {
            if (s == null) {
                throw ArgumentNullException("s");
            }
            if (index < 0 || index >= s.Length) {
...
// [Pure]
        ...
        public static bool IsSurrogatePairstring s, int index) {
            if (s == null) {
                throw ArgumentNullException("s");
            }
            if (index < 0 || index >= s.Length) {
...
// [Pure]
        ...
        ** Convert an UTF32 value into a surrogate pair.
        ...
        public staticstring ConvertFromUtf32(int utf32)
        {
            ...
            if ((utf32 < 0 || utf32 > UNICODE_PLANE16_END) || (utf32 >= HIGH_SURROGATE_START && utf32 <= LOW_SURROGATE_END)) {
                throw ArgumentOutOfRangeException("utf32", Environment.GetResourcestring("ArgumentOutOfRange_InvalidUTF32"));
            }
            Contract.EndContractBlock();
        ...
        ** Convert a surrogate pair to UTF32 value                                    
        ...
        public static int ConvertToUtf32(char highSurrogate, char lowSurrogate) {
            if (!IsHighSurrogate(highSurrogate)) {
                throw ArgumentOutOfRangeException("highSurrogate", Environment.GetResourcestring("ArgumentOutOfRange_InvalidHighSurrogate")); 
            }
            if (!IsLowSurrogate(lowSurrogate)) {
                throw ArgumentOutOfRangeException("lowSurrogate", Environment.GetResourcestring("ArgumentOutOfRange_InvalidLowSurrogate"));
            }
            Contract.EndContractBlock();
        ...
        ** This method throws if a low surrogate is seen without preceding a high-surrogate.
        ...
        public static int ConvertToUtf32string s, int index) {
            if (s == null) {
                throw ArgumentNullException("s");
            }

            if (index < 0 || index >= s.Length) {
                throw ArgumentOutOfRangeException("index", Environment.GetResourcestring("ArgumentOutOfRange_Index"));
            }
            Contract.EndContractBlock();
                ...
                if (temp1 <= 0x3ff) {
                    ...
                    if (index < s.Length - 1) {
                        ...
                        if (temp2 >= 0 && temp2 <= 0x3ff) {
                            ...
                            throw ArgumentException(Environment.GetResourcestring("Argument_InvalidHighSurrogate", index), "s"); 
                        }
                    } else {
                    ...
                    throw ArgumentException(Environment.GetResourcestring("Argument_InvalidLowSurrogate", index), "s"); 
                }
            }
