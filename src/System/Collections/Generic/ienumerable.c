...
GType system_collections_generic_ienumerable_get_type (void) {
	...
	if (g_once_init_enter (&system_collections_generic_ienumerable_type_id__volatile)) {
		...
		g_type_interface_add_prerequisite (system_collections_generic_ienumerable_type_id, G_TYPE_OBJECT);
