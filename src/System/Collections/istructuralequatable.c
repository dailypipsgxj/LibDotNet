/* istructuralequatable.c generated by valac 0.26.2, the Vala compiler
...
GType system_collections_istructural_equatable_get_type (void) {
	...
	if (g_once_init_enter (&system_collections_istructural_equatable_type_id__volatile)) {
		...
		g_type_interface_add_prerequisite (system_collections_istructural_equatable_type_id, G_TYPE_OBJECT);
