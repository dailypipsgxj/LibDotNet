...
namespace System {
	namespace Collections {
		namespace Generic {
			...
			[CCode (cheader_filename = "libdotnet.h")]
			public abstract class AbstractList<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IList<T>, System.Collections.Generic.IReadOnlyCollection<T>, System.Collections.Generic.IReadOnlyList<T> {
				public AbstractList ();
			...
			[CCode (cheader_filename = "libdotnet.h")]
			public class Queue<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IReadOnlyCollection<T> {
				public class Enumerator<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerator<T> {
					public void Dispose ();
				}
			...
			[CCode (cheader_filename = "libdotnet.h")]
			public class Stack<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IReadOnlyCollection<T> {
				public class Enumerator<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerator<T> {
			...
			[CCode (cheader_filename = "libdotnet.h")]
			[GenericAccessors]
			public interface IEnumerable<T> : System.Linq.Enumerable<T> {
			...
			[CCode (cheader_filename = "libdotnet.h")]
			[GenericAccessors]
			public interface IEnumerator<T> : System.Linq.Enumerable<T> {
		...
		namespace ObjectModel {
			[CCode (cheader_filename = "libdotnet.h")]
			[GenericAccessors]
			public class ReadOnlyCollection<T> : System.Linq.Enumerable<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IReadOnlyCollection<T> {
	...
	namespace Linq {
		...
		public abstract class Enumerable<TSource> : GLib.Object {
			public Enumerable ();
			public virtual System.Collections.Generic.IEnumerable<TSource> Where (System.Func<TSource,bool> predicate);
		}
	}
